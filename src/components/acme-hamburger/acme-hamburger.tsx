...
export class AcmeHamburger implements ComponentInterface {
  ...
  componentDidLoad() {
    ...
    this.menu = document.querySelector('app-container').shadowRoot.querySelector('acme-navbar').shadowRoot.querySelector('lower-bar').shadowRoot.querySelector('hamburger-body');
